...
%>
<script language="javascript" src="reg_ajax.js">
...
function checkName() {
	...
	if(username=="") {
		...
		createRequest('checkName.jsp?c_name='+username);
	}
}
</script>
<style type="text/css">
...
<center>
	<form name="form1" action="" method="post" onsubmit="return check_name(this);">
    ...
    <td width="543" align="left" valign="middle" bgcolor="#99CCFF">&nbsp;&nbsp;&nbsp;
      <%if(name==null || name==""){%><input type="text" name="username" /><%}else{%><input type="text" name="username" value="<%=name%>" /><%}%>
      <span class="STYLE3">*</span><a href="#" onClick="checkName()" ><span class="STYLE1">[检测用户名]</span></a>
