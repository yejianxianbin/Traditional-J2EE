...
<form action="login_ok.jsp" method="post" onSubmit="return check_login(this);">
    <table width="180" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CCFF" bgcolor="#eeeeee" style="border-collapse:collapse">
      ...
      <tr>
        <td height="30" colspan="2" align="center" valign="middle"><font size="2"><a href="forget_pass.jsp">忘记密码?</a>  </font><input type="submit" class="STYLE1" value="确定" />&nbsp;<input type="button" class="STYLE1" value="注册" onClick="window.location.href='registry.jsp'" /></td>
      </tr>
  </table>
</form>
		<%
      ...
      <tr>
        <td width="68" rowspan="5" align="right" valign="middle"><img src="<%= c_header %>" width="40" height="40" /><p><span class="STYLE1"><%= c_name %></span></p></td>
        <td height="17" align="left" valign="top">&nbsp;&nbsp;<span class="STYLE1"><a href="my_cart.jsp">我的购物车</a></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="17" align="left">&nbsp;&nbsp;<span class="STYLE1"><a href="cust_update.jsp">修改我的资料</a></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="14" colspan="2" align="center"><span class="STYLE1">&nbsp;您是第 <font color="#FF0000"><%= temp-1 %></font> 次登录本站</span></td>
        </tr>
    </table>
	<%
		}
