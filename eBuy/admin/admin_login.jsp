...
<table width="233" border="1" bordercolor="#99CCFF" style="border-collapse:collapse" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="51"><form action="admin_login_ok.jsp" method="post" onSubmit="return check_admin(this);">
<table width="409" border="0" bordercolor="#99CCFF" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="263" align="left" valign="middle">&nbsp;<input type="text" name="a_name" size="20" /></td>
  </tr>
  <tr>
    <td width="146" height="30" align="right"><span class="STYLE2">密码</span>：</td>
    <td height="30" align="left" valign="middle">&nbsp;<input type="password" name="a_pass" size="21" /></td>
  </tr>
  <tr>
    <td height="30" align="right">&nbsp;</td>
    <td height="30" align="center">&nbsp;<input name="submit" type="submit" class="STYLE1" value=" 确定 " /></td>
  </tr>
</table>
</form></td>
  </tr>
