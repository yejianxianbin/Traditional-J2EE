...
<% 
	...
	{
		out.println( "<HTML><HEAD><META http-equiv='refresh' content='1; URL=product_all.jsp' target=Main></HEAD><BODY bgcolor='#FFFFFF'><center><font size=4pt color='red'>" + "и╬ЁЩй╖╟э!гКит╨Ртыйт..." + "</font></center></body></html>");
	}
